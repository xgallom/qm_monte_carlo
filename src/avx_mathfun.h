...
v8sf log256_ps(v8sf x) {
  ...
  x = _mm256_max_ps(x, *reinterpret_cast<const v8sf *>(_ps256_min_norm_pos));  /* cut off denormalized stuff */
  ...
  imm0 = avx2_mm256_sub_epi32(imm0, *reinterpret_cast<const v8si *>(_pi32_256_0x7f));
  ...
  */
  //v8sf mask = _mm256_cmplt_ps(x, *reinterpret_cast<const v8sf *>(_ps256_cephes_SQRTHF);
  v8sf mask = _mm256_cmp_ps(x, *reinterpret_cast<const v8sf *>(_ps256_cephes_SQRTHF), _CMP_LT_OS);
...
v8sf exp256_ps(v8sf x) {
  ...
  tmp = _mm256_mul_ps(fx, *reinterpret_cast<const v8sf *>(_ps256_cephes_exp_C1));
  v8sf z = _mm256_mul_ps(fx, *reinterpret_cast<const v8sf *>(_ps256_cephes_exp_C2));
  ...
  imm0 = avx2_mm256_add_epi32(imm0, *reinterpret_cast<const v8si *>(_pi32_256_0x7f));
...
v8sf sin256_ps(v8sf x) { // any x
  ...
  sign_bit = _mm256_and_ps(sign_bit, *reinterpret_cast<const v8sf *>(_ps256_sign_mask));
  ...
  */
  ...
  imm2 = avx2_mm256_add_epi32(imm2, *reinterpret_cast<const v8si *>(_pi32_256_1);
  imm2 = avx2_mm256_and_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_inv1);
  y = _mm256_cvtepi32_ps(imm2);

  /* get the swap sign flag */
  imm0 = avx2_mm256_and_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_4);
  ...
  */
  imm2 = avx2_mm256_and_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_2);
  imm2 = avx2_mm256_cmpeq_epi32(imm2,*reinterpret_cast<const v8si *>(_pi32_256_0);
#else
  ...
  imm2_1 = _mm_and_si128(imm2_1, *reinterpret_cast<const v4si *>(_pi32avx_inv1));
  imm2_2 = _mm_and_si128(imm2_2, *reinterpret_cast<const v4si *>(_pi32avx_inv1));
...
v8sf cos256_ps(v8sf x) { // any x
  ...
  imm2 = avx2_mm256_and_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_inv1);
  y = _mm256_cvtepi32_ps(imm2);
  imm2 = avx2_mm256_sub_epi32(imm2, *reinterpret_cast<const v8si *>(_pi32_256_2);
  
  /* get the swap sign flag */
  imm0 = avx2_mm256_andnot_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_4);
  imm0 = avx2_mm256_slli_epi32(imm0, 29);
  /* get the polynom selection mask */
  imm2 = avx2_mm256_and_si256(imm2, *reinterpret_cast<const v8si *>(_pi32_256_2);
  imm2 = avx2_mm256_cmpeq_epi32(imm2, *reinterpret_cast<const v8si *>(_pi32_256_0);
  ...
  imm0_1 = _mm_andnot_si128(imm2_1, *reinterpret_cast<const v4si *>(_pi32avx_4));
  imm0_2 = _mm_andnot_si128(imm2_2, *reinterpret_cast<const v4si *>(_pi32avx_4));
...
void sincos256_ps(v8sf x, v8sf *s, v8sf *c) {
  ...
  x = _mm256_and_ps(x, *reinterpret_cast<const v8sf *>(_ps256_inv_sign_mask));
  /* extract the sign bit (upper one) */
  sign_bit_sin = _mm256_and_ps(sign_bit_sin, *reinterpret_cast<const v8sf *>(_ps256_sign_mask));
...
#ifdef __AVX2__
  imm4 = avx2_mm256_sub_epi32(imm4, *reinterpret_cast<const v8si *>(_pi32_256_2);
  imm4 = avx2_mm256_andnot_si256(imm4, *reinterpret_cast<const v8si *>(_pi32_256_4);
  ...
  imm4_1 = _mm_andnot_si128(imm4_1, *reinterpret_cast<const v4si *>(_pi32avx_4));
  imm4_2 = _mm_andnot_si128(imm4_2, *reinterpret_cast<const v4si *>(_pi32avx_4));
